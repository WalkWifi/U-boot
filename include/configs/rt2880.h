...
#define SERIAL_CLOCK_DIVISOR    16    //weikk add 20160718

#define CONFIG_BOOTDELAY	    2	/* autoboot after 5 seconds	*/  //weikk add 20160314

#define CONFIG_BAUDRATE		    230400//57600
